                ...
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="flex justify-between h-24">
                        <div class="flex">
                            <!-- Logo -->
                            <div
                                class="flex items-center shrink-0 bg-emerald-500"
                            >
                                <Link :href="route('dashboard')">
                                    <ApplicationLogo
                                        class="block w-auto h-24 text-gray-800 fill-current"
                                    />
                                </Link>
                            </div>
                            ...
                            >
                                ...
                                <NavLink
                                    ...
                                    :active="
                                        route().current('availability-status.*')
                                    "
                                >
                                    Availability Status
                                </NavLink>
