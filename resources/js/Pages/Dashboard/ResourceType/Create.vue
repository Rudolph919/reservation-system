        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <form @submit.prevent="form.post(route('resource-type.store'), { onSuccess: () => form.reset() })">
                        <TextInput id="resourceType" v-model="form.resourceType" type="text" class="mt-1 block w-full"/>
