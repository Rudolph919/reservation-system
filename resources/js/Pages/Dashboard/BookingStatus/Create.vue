                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex justify-between pb-4">
                        ...
                        <div>
                            ...
                            >
                                View Booking Status List
                            </PrimaryNavLink>
                        </div>
                    </div>
                    <form @submit.prevent="form.post(route('booking-status.store'), { onSuccess: () => form.reset() })">
                        <TextInput id="bookingStatus" v-model="form.bookingStatus" type="text" class="mt-1 block w-full"/>
